...
# Title: TeoremaNyquist
# Author: Cristian_Rugeles_Diana_Ariza_2_L1A
...
class Lab1_Punto4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "TeoremaNyquist", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("TeoremaNyquist")
        ...
        labels = ['Signal', 'Interpolation', 'Decimation', 'Signal 4', 'Signal 5',
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/media/diana/Nuevo vol/USUARIO/1Personal/1 UIS/2023-1/Comunicaciones I/Lab/despecha_rosalia.wav', True)
