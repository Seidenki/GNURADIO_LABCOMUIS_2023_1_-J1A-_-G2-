...
class Lab2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._A_range = Range(0, 1, 1e-4, 500e-3, 200)
        self._A_win = RangeWidget(self._A_range, self.set_A, "Amplitud de señal TX", "counter_slider", float, QtCore.Qt.Horizontal)
